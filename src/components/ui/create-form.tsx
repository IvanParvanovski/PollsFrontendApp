...
function CreateForm() {
  ...
  return (
    <div className="w-full max-w-2xl bg-[var(--color-midnight)] mx-auto p-6 space-y-6 rounded-2xl">
      {/* Heading */}
      <div>
        <h1 className="text-3xl font-['Lexend'] text-white font-bold dark:text-white tracking-tight mb-1">
          Create a Poll
        </h1>
        <p className="text-sm text-gray-400 dark:text-gray-400">
          Fill out the form below to publish your new poll.
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li className="text-md text-lime-600 flex items-center gap-2 dark:text-gray-200 pl-4">
